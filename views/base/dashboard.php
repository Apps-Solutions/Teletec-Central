    ...
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
        <div class="row">
          <div class="col-xs-12 col-sm-1 col-md-1 col-lg-1">Usuarios:</div>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12  pading_bottom ">
        	<div  class="row">
          	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pading_bottom ">
            	<span class="flotar_izquierda">Desde:</span>
        			<div id="div_desde" class="input-append date">
        				<input type="text" name="inp_desde"  id="inp_desde" class="tam_text_fecha flotar_izquierda text_negro"   >
        ...
        <div class="modal-body ">
          ...
          <div class="row pading_left_30">
          	<div class="col-lg-8 text_negro ">
                  ...
                  <div class="hidden-xs col-sm-7 col-md-7 col-lg-6"></div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="row over_flou margen_bottom ">
                      	<div class="col-xs-12 col-sm-5 col-md-7 col-lg-5 ">
                          <? for ($c=0; $c<20;$c++)
                          {?>
                              <div class="row">
                                  <div class="col-xs-4 col-sm-6 col-md-6 col-lg-6">Antena:</div>
                                  <div class="col-xs-68 col-sm-6 col-md-6 col-lg-6">1</div>
                              </div>
                          <?php
                          }?>
                        </div>
            ...
            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text_negro ">
            	<div class="row margen_bottom margin_top_15">Evidencias</div>
